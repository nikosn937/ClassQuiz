...
QUIZZES = {
    ...
    "Γ.7.Μ2: Αναπαράσταση Αλγορίθμων με Λογικά Διαγράμματα": [
        {
            "question": (
                "1. Ποιο από τα παρακάτω σύμβολα χρησιμοποιείται για τη δήλωση"
                " της Αρχής και του Τέλους σε ένα Λογικό Διάγραμμα;"
            ),
            "options": [
                "Έλλειψη (ή Στρόγγυλο Ορθογώνιο)",
                "Παραλληλόγραμμο",
                "Ορθογώνιο",
                "Ρόμβος",
            ],
            "answer": "Έλλειψη (ή Στρόγγυλο Ορθογώνιο)",
        },
        {
            "question": (
                "2. Για την εκτέλεση πράξεων και υπολογισμών (π.χ. x = a + b),"
                " ποιο σύμβολο χρησιμοποιούμε στο Διάγραμμα Ροής;"
            ),
            "options": [
                "Ορθογώνιο",
                "Παραλληλόγραμμο",
        ...
        {
            "question": (
                "3. Ποιο σύμβολο εκφράζει τις εντολές Εισόδου (Διάβασε) και"
                " Εξόδου (Τύπωσε) δεδομένων;"
            ),
            "options": [
            ...
            "answer": "Πλάγιο Παραλληλόγραμμο",
        },
        {
            "question": (
                "4. Ο Ρόμβος σε ένα Λογικό Διάγραμμα χρησιμοποιείται για:"
            ),
            "options": [
                "Έλεγχο συνθήκης / Λήψη απόφασης (π.χ. x > 0;)",
                "Εισαγωγή δεδομένων από το πληκτρολόγιο",
                "Αναγραφή του τίτλου του αλγορίθμου",
                "Εκτέλεση αριθμητικών υπολογισμών",
            ],
            "answer": "Έλεγχο συνθήκης / Λήψη απόφασης (π.χ. x > 0;)",
        },
        {
            "question": (
                "5. Τι εκφράζει μια Μεταβλητή στην Πληροφορική;"
            ),
            "options": [
                "Μια θέση στη μνήμη του υπολογιστή με όνομα, της οποίας το περιεχόμενο μπορεί να μεταβάλλεται",
                "Έναν σταθερό αριθμό που δεν αλλάζει ποτέ",
                "Το όνομα του προγράμματος που εκτελούμε",
                "Τον χρόνο που χρειάζεται ο αλγόριθμος για να τερματίσει",
            ],
            "answer": "Μια θέση στη μνήμη του υπολογιστή με όνομα, της οποίας το περιεχόμενο μπορεί να μεταβάλλεται",
        },
        {
            "question": (
                "6. Ποια είναι η σωστή λογική ακολουθία συμβόλων για έναν αλγόριθμο που διαβάζει έναν αριθμό x και τυπώνει το διπλάσιό του (y = 2 * x);"
            ),
            "options": [
                "Έλλειψη (Αρχή) ➔ Παραλληλόγραμμο (Διάβασε x) ➔ Ορθογώνιο (y = 2 * x) ➔ Παραλληλόγραμμο (Τύπωσε y) ➔ Έλλειψη (Τέλος)",
                "Έλλειψη (Αρχή) ➔ Ορθογώνιο (Διάβασε x) ➔ Παραλληλόγραμμο (y = 2 * x) ➔ Έλλειψη (Τέλος)",
                "Παραλληλόγραμμο (Αρχή) ➔ Ρόμβος (x) ➔ Ορθογώνιο (y = 2 * x) ➔ Έλλειψη (Τέλος)",
                "Έλλειψη (Αρχή) ➔ Ρόμβος (Διάβασε x) ➔ Ορθογώνιο (Τύπωσε y) ➔ Έλλειψη (Τέλος)",
            ],
            "answer": "Έλλειψη (Αρχή) ➔ Παραλληλόγραμμο (Διάβασε x) ➔ Ορθογώνιο (y = 2 * x) ➔ Παραλληλόγραμμο (Τύπωσε y) ➔ Έλλειψη (Τέλος)",
        },
        {
            "question": (
                "7. Ποια από τις παρακάτω εντολές εκφράζει σωστά μια εκχώρηση τιμής σε μεταβλητή;"
            ),
            "options": [
                "Sum ⟵ a + b",
                "a + b = Sum",
        ...
        {
            "question": (
                "8. Αν σε ένα διάγραμμα ροής η μεταβλητή A έχει αρχική τιμή 5 και εκτελεστεί η εντολή A ⟵ A + 3, ποια θα είναι η νέα τιμή της A;"
            ),
            "options": [
                "8",
                "53",
