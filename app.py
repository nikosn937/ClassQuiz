...
QUIZZES = {
    "Γ.7.Μ1: Αλγόριθμοι - Χαρακτηριστικά": [
        ...
        {
            "question": "2. Ποια από τις παρακάτω προτάσεις περιγράφει σωστά την έννοια του Αλγόριθμου;",
            "options": [
                "Μια αυστηρά καθορισμένη αλληλουχία βημάτων που οδηγεί στην επίλυση ενός προβλήματος",
            ...
            "answer": "Μια αυστηρά καθορισμένη αλληλουχία βημάτων που οδηγεί στην επίλυση ενός προβλήματος"
        },
        {
            "question": "3. Όταν λέμε ότι ένας Αλγόριθμος πρέπει να διακρίνεται από Σαφήνεια, εννοούμε ότι:",
            "options": [
            ...
            "answer": "Κάθε εντολή πρέπει να επιδέχεται μία μόνο μονοσήμαντη ερμηνεία"
        },
        {
            "question": "4. Το χαρακτηριστικό της Περατότητας εξασφαλίζει ότι ο Αλγόριθμος:",
            "options": [
                "Δεν θα κολλήσει σε ατέρμονα βρόγχο (εκτέλεση χωρίς τέλος) και θα τερματίσει μετά από πεπερασμένο αριθμό βημάτων",
                "Θα δίνει πάντα το ίδιο αποτέλεσμα",
                "Θα αποτελείται το πολύ από 10 βήματα",
                "Θα εκτελεστεί στον ταχύτερο δυνατό χρόνο"
            ],
            "answer": "Δεν θα κολλήσει σε ατέρμονα βρόγχο (εκτέλεση χωρίς τέλος) και θα τερματίσει μετά από πεπερασμένο αριθμό βημάτων"
        },
        {
            "question": "5. Η Αποτελεσματικότητα ως χαρακτηριστικό ενός Αλγόριθμου σημαίνει ότι:",
            "options": [
                "Κάθε εντολή είναι αρκετά απλή ώστε να μπορεί να εκτελεστεί μηχανικά σε πεπερασμένο χρόνο",
            ...
            "answer": "Κάθε εντολή είναι αρκετά απλή ώστε να μπορεί να εκτελεστεί μηχανικά σε πεπερασμένο χρόνο"
        },
        {
            "question": "6. Ποια είναι η σωστή σειρά εντολών για τον αλγόριθμο υπολογισμού του Μέσου Όρου δύο αριθμών;\n1. Διάβασε τον δεύτερο αριθμό (Β)\n2. Τύπωσε το αποτέλεσμα (ΜΟ)\n3. Υπολόγισε ΜΟ = (Α + Β) / 2\n4. Διάβασε τον πρώτο αριθμό (Α)",
            "options": [
                "4, 1, 3, 2",
                "1, 4, 2, 3",
                "4, 3, 1, 2",
        ...
        {
            "question": "7. Ποια είναι η σωστή σειρά βημάτων για τη διαγραφή μιας παραγράφου σε έναν Επεξεργαστή Κειμένου (Word);\n1. Πίεσε το πλήκτρο Delete\n2. Επίλεξε (μάρκαρε) την παράγραφο με το ποντίκι\n3. Τοποθέτησε τον δρομέα στην αρχή της παραγράφου",
            "options": [
                "3, 2, 1",
                "2, 3, 1",
                "1, 2, 3",
        ...
        {
            "question": "8. Ένας μαθητής έγραψε αλγόριθμο για να σχεδιάσει ένα ισόπλευρο τρίγωνο:\n1. Σχεδίασε ευθύγραμμο τμήμα 10 cm\n2. Στρίψε δεξιά 120°\n3. Σχεδίασε ευθύγραμμο τμήμα 10 cm\n4. Στρίψε αριστερά 120°\n5. Σχεδίασε ευθύγραμμο τμήμα 10 cm\nΠού υπάρχει το λογικό σφάλμα;",
            "options": [
...
def student_dashboard():
    # 1. Αρχικοποίηση μεταβλητής στο Session State
...
if attempts_count < 2:
            with st.form("quiz_form"):
                ...
                for i, q in enumerate(questions):
                    ...
                    # index=None για να μην υπάρχει προεπιλεγμένη απάντηση
